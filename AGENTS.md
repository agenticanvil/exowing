...
For level work, launch the target level with `?play=<id>&dev=invulnerable`, test mid-level play, and use DEV MENU → DEV SETTINGS → SWITCH LEVEL for quick comparisons.
